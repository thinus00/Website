<?php require($_SERVER['DOCUMENT_ROOT'] . '/assets/php/getPower.php' ); ?> 
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand">Temperature</a>
        </div>
      </div>
    </div>
	  ...
	  <div class="main" id="content">
	  	...
	  	<div class="col-lg-7">
			  ...
			  <?php while( $row = $result2->fetch(PDO::FETCH_ASSOC) ) { ?>
			  	<tr class="">
					<td><?php echo $row['powerid']; ?></td>
                                        <td><?php echo $row['name']; ?></td>
				  	<td><?php echo $row['timestamp']; ?></td>
				  	<td><?php echo $row['rtKW']; ?></td>
                                        <td><?php echo $row['cummPulses']; ?></td>
                                        <td><?php echo $row['cummKWH']; ?></td>
				  	</tr>
				  	<?php } ?>
			  </table>
	  	</div>
